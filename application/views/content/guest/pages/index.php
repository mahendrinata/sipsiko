<div id="slider">
  <div class="fullwidthbanner-container">
    <div class="fullwidthbanner">
      <ul>
        <li data-transition="fade" data-slotamount="10" data-thumb="<?php echo base_url().'assets/frontend/img/'; ?>thumbs/thumb1.jpg">
          <img src="<?php echo base_url().'assets/frontend/img/'; ?>slides/thumb1.jpg">
          <div class="caption lft" data-x="0" data-y="10" data-speed="900" data-start="900" data-easing="easeOutExpo"><img src="<?php echo base_url().'assets/frontend/img/'; ?>slides/glare.png"></div>
          <div class="caption lfl" data-x="-30" data-y="20" data-speed="900" data-start="1300" data-easing="easeOutBack"><img src="<?php echo base_url().'assets/frontend/img/'; ?>model1.png"></div>
          <div class="caption lft big_grey"  data-x="506" data-y="120" data-speed="400" data-start="1700" data-easing="easeOutExpo">Responsive Design</div>
          <div class="caption lft big_orange"  data-x="506" data-y="157" data-speed="400" data-start="1900" data-easing="easeOutExpo">Works well ondevices in portrait and landscape mode</div>
          ...
          <div class="caption sfb" data-x="510" data-y="360" data-speed="1000" data-start="1800" data-easing="easeOutBack">
            <?php echo anchor('register', 'Register Company or Member', 'class="btn-image"');?>
          </div>
        </li>
        <li data-transition="slideup" data-slotamount="7" data-thumb="<?php echo base_url().'assets/frontend/img/'; ?>thumbs/thumb2.png">
          <img src="<?php echo base_url().'assets/frontend/img/'; ?>slides/thumb2.jpg">
          <div class="caption sfb" data-x="0" data-y="10" data-speed="900" data-start="900" data-easing="easeOutSine"><img src="<?php echo base_url().'assets/frontend/img/'; ?>slides/glare2.png"></div>
          <div class="caption lft" data-x="140" data-y="50" data-speed="900" data-start="1700" data-easing="easeOutBack"><img src="<?php echo base_url().'assets/frontend/img/'; ?>model3.png"></div>
        ...
        <li data-transition="fade" data-slotamount="10" data-thumb="<?php echo base_url().'assets/frontend/img/'; ?>thumbs/thumb1.jpg">
          <img src="<?php echo base_url().'assets/frontend/img/'; ?>slides/thumb1.jpg">
          <div class="caption lft" data-x="0" data-y="10" data-speed="900" data-start="900" data-easing="easeOutExpo"><img src="<?php echo base_url().'assets/frontend/img/'; ?>slides/glare.png"></div>
          <div class="caption lfl" data-x="-30" data-y="20" data-speed="900" data-start="1300" data-easing="easeOutBack"><img src="<?php echo base_url().'assets/frontend/img/'; ?>model2.png"></div>
